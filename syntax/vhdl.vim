...
" comment
syntax keyword vhdlTodo xxx todo fixme contained
syntax keyword vhdlError zzz contained
syn match vhdlComment "--.*$" contains=vhdlTodo,vhdlError
" syn match vhdlGlobal "[\'$#~!%@?\^\[\]{}\\]"

"syn region vhdlFoldBracket start="(" end=")" transparent fold keepend extend
"syn region vhdlFoldComponent start="^\s*\<component\>" end="^\s*\<end\s\+component" transparent fold keepend extend
